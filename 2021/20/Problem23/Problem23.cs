...
{
    [GeneratedTest<long>(12521, 15338)]
    public static long RunA(string[] lines)
    {
        throw new NotImplementedException();

        var units = LoadData(lines);

        return Recurse(0, 0, Int32.MaxValue, units, -1);
    }

    [GeneratedTest<long>(44169, -1)]
    public static long RunB(string[] lines)
    {
        throw new NotImplementedException();
    }

    static readonly Dictionary<string, int> history = [];

    static int Recurse(int level, int cost, int parentBestCost, Unit[] units, int lastUnitIndex)
    {
    ...
    static readonly Dictionary<NodeType, int> costs = new()
    {
        [NodeType.A] = 1,
        [NodeType.B] = 10,
        [NodeType.C] = 100,
    ...
    static Unit[] LoadData(string[] lines)
    {
